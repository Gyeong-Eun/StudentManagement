...
class PersonnelReg : AppCompatActivity() {
    ...
    lateinit var re_gender : RadioGroup
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        re_gender = findViewById(R.id.gender)
        ...
        btnRegister.setOnClickListener {
            ...
            if (re_gender.checkedRadioButtonId == R.id.male) {
                str_gender = rb_gender_m.text.toString()
            }
            if (re_gender.checkedRadioButtonId == R.id.female) {
